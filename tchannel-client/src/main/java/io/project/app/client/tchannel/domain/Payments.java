package io.project.app.client.tchannel.domain;
...
public class Payments implements Serializable {
    ...
    private String creditAccountType; //ACCOUNT, CARD, CRYPTO_ACCOUNT
    @Basic(optional = false)
    @Column(name = "credit_account", updatable = false)
    private String creditAccount;
    @Basic(optional = false)
    @Column(name = "debit_account_type", updatable = false)
    private String debitAccountType; //ACCOUNT, CARD, CRYPTO_ACCOUNT
    @Basic(optional = false)
